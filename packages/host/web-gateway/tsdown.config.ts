...
/**
 * The web-gateway ships three published entries: the plugin/library entry, the
 * invariant companion, and the CLI bin referenced by package.json `bin`. Each
 * builds as a self-contained file admitted by the package whitelist.
 */
